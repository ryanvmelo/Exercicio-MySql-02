...
select count(*) as "Quantidade de Funcionários", departamento from funcionarios
group by departamento
order by 1;

--Traga os funcionários que tabalhem no departamento de filmes ou no departamento de roupas
select count(*) as "Quantidade de Funcionários", departamento from funcionarios
group by departamento
order by 1;
...
--O gestor de marketing pediu a lista das funcionárias que trabalham no departamento de filmes ou
--no departamento de lar. Ele precisa enviar um e-mail para elas.
select count(*) as "Quantidade de Funcionários", sexo from funcionarios
group by sexo
order by 1;
...
where 
(sexo = 'feminino' and departamento = 'lar')
or
(sexo = 'feminino' and departamento = 'filmes');

--Traga os funcionarios do sexo masculino ou os funcionarios que trabalhem
-- no setor jardim
select * from funcionarios
where
sexo = 'Masculino'
